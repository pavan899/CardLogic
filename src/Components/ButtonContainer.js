...
const ButtonContainer = ({ dropCard, totalCards, selectedCards, Cards, discardCard, finishGame, groupCards, sortCards }) => {
    return <div className="ButtonContainer">
        <div className="scoreTimer">
            <img src="./Assets/Icons/playerTimer.svg" className="playerTimer" />
        </div>
        <div className="ButtonList">
            {(selectedCards.length === 0&& totalCards === 13) && <img src={`./Assets/Buttons/Drop.svg`} onClick={dropCard} className="BtnImages" alt="discard" />}
            ...
            {(selectedCards.length === 1 && totalCards === 14)&&<img src={`./Assets/Buttons/Finish.svg`} onClick={finishGame} className="BtnImages" alt="finish" />}
